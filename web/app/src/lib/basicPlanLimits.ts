/**
 * Core tier's monthly transcription allowance, shown to signed-out-of-a-paid-plan
 ...
 * set `BASIC_TIER_MINUTES_LIMIT_PER_MONTH=300`, matching the canonical `basic` (Core) plan's
 ...
 * allocation changes.
 */
export const CORE_TIER_TRANSCRIPTION_MINUTES_LIMIT = 300;
export const CORE_TIER_TRANSCRIPTION_SECONDS_LIMIT =
