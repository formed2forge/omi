...
void main() {
  ...
  group('PlanType semantics', () {
    ...
    test('unlimited tiers have no transcription cap', () {
      ...
      expect(PlanType.max.hasUnlimitedTranscription, isTrue);
      expect(PlanType.basic.hasUnlimitedTranscription, isFalse);
    });

    test('Plus and Max grant desktop under the unified catalog', () {
      ...
      expect(PlanType.max.grantsDesktop, isTrue);
    ...
    test('Plus and Max are mobile storefront plans while desktop-only legacy plans are manage-only', () {
      expect(PlanType.plus.isSoldOnMobile, isTrue);
      expect(PlanType.max.isSoldOnMobile, isTrue);
      expect(PlanType.plus.isMobileManageOnly, isFalse);
      expect(PlanType.max.isMobileManageOnly, isFalse);
